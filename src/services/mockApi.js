...
const buildRankedMatches = () => ([
  { win: true, result: 'Win', mode: 'Competitive', map: 'Kingâ€™s Row', scoreFor: 3, scoreAgainst: 2, playedAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2).toISOString() },
  ...
  { win: false, result: 'Loss', mode: 'Competitive', map: 'EsperanÃ§a', scoreFor: 1, scoreAgainst: 2, playedAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 6).toISOString() },
